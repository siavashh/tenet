...
gulp.task("scripts", function () {
  var scripts = [
    // Start - All BS4 stuff
    paths.dev + "/js/bootstrap5/bootstrap.js",
...
gulp.task("copy-assets", function (done) {
  ...
  // Copy all Vazir Fonts
  gulp
    .src([
      paths.node + "/vazir-font/dist/**/Vazir-Regular.{ttf,woff,woff2,eot}",
      paths.node + "/vazir-font/dist/**/Vazir-Bold.{ttf,woff,woff2,eot}",
    ])
    .pipe(gulp.dest(paths.fonts));
