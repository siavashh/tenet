	...
	function widget_classes($params)
	{
		...
		if (isset($params[0]['id']) && strpos($params[0]['before_widget'], 'dynamic-classes')) {
			...
			if (0 === $widget_count % 4 || $widget_count > 6) {
				...
				$widget_classes .= ' col-md-6 col-xl-3';
...
add_action('widgets_init', 'tenet_widgets_init');



if (!function_exists('tenet_widgets_init')) {

	/**
	 * Initializes themes widgets.
	 */

	function tenet_widgets_init()
	{
		$bordertype = get_theme_mod('border_type');
		register_sidebar(
			array(
				'name'          => __('Right Sidebar', 'tenet'),
				'id'            => 'right-sidebar',
				'description'   => __('Right sidebar widget area', 'tenet'),
		...
		register_sidebar(
			array(
				'name'          => __('Left Sidebar', 'tenet'),
				'id'            => 'left-sidebar',
				'description'   => __('Left sidebar widget area', 'tenet'),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __('Hero Slider', 'tenet'),
				'id'            => 'hero',
				'description'   => __('Hero slider area. Place two or more widgets here and they will slide!', 'tenet'),
		...
		register_sidebar(
			array(
				'name'          => __('Hero Canvas', 'tenet'),
				'id'            => 'herocanvas',
				'description'   => __('Full size canvas hero area for Bootstrap and other custom HTML markup', 'tenet'),
				'before_widget' => '',
				'after_widget'  => '',
				'before_title'  => '',
				'after_title'   => '',
		...
		register_sidebar(
			array(
				'name'          => __('Top Full', 'tenet'),
				'id'            => 'statichero',
				'description'   => __('Full top widget with dynamic grid', 'tenet'),
		...
		register_sidebar(
			array(
				'name'          => __('Footer Full', 'tenet'),
				'id'            => 'footerfull',
				'description'   => __('Full sized footer widget with dynamic grid', 'tenet'),
...
} // End of function_exists( 'tenet_widgets_init' ).

include( get_template_directory() . '/inc/tenet-popular-widget.php');