...
if (!function_exists('tenet_adjust_body_class')) {
	 ...
	 */
	function tenet_adjust_body_class($classes)
	{
...
if (!function_exists('tenet_slbd_count_widgets')) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function tenet_slbd_count_widgets($sidebar_id)
	{
		...
		$tenet_sidebars_widgets_count = $_wp_sidebars_widgets;
		if (isset($tenet_sidebars_widgets_count[$sidebar_id])) :
			$widget_count   = count($tenet_sidebars_widgets_count[$sidebar_id]);
			$widget_classes = 'widget-count-' . count($tenet_sidebars_widgets_count[$sidebar_id]);
